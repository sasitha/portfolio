      ...
      <section id='about_me' className='pt-10'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
          ...
          <div className='text-left'>
            ...
            <p className='text-base font-medium pt-2 text-justify'>
              I'm available on the following professional and social media networks. Feel free to check out my accounts and contact me to discuss any work or collaborative project ideas.
            </p>
            <div className='flex justify-center space-x-5 mt-5'>
              <a href='https://github.com/sasitha' target='_blank'>
              ...
              <a href='https://www.linkedin.com/in/sasitha/' target='_blank'>
              ...
              <a href='https://twitter.com/sasitha1989' target='_blank'>
